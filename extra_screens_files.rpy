                ...
                if FileType == 'Mementos':
                    ...
                    if Memento == "Tablet13":
                        vbox spacing 10:
                            ...
                            text "{i}\"Para ver além dessas paredes e do mar? De forma alguma, ouvi pouquíssimas histórias,"
                            ...
                            text "{i}Posso deixar essas paredes, mas haverá outro labirinto para mim"
                            ...
                            text "{i}Minha vontade dificilmente importa neste caso, independente de eu desejar ou não a liberdade,"
                            ...
                            text "{i}tenho a esperança de ver minha família mais uma vez, a esperança de sua próxima visita."
                    ...
                    if Memento == "Tablet14":
                        vbox spacing 10:
                            text "{i}{size=+2}Décima Quarta Tábua: Redeemer" xalign 0.5
                            text ""
                            ...
                            text "{i}Em breve acabaremos com a dor de meu pai, e então você verá"
                            text "{i}como uma libertação de pesadas algemas, e enxergar a si mesmo como seu querido redentor.\""
                            text ""
                    ...
                    if Memento == "Tablet15":
                        vbox spacing 10:
                            ...
                            text "Ainda assim, algumas brasas possuem uma segunda vida, revelada quando a camada de fuligem voa para revelar um coração ainda vermelho."
                            ...
                            text "{i}embora o meu não fosse de mal-estar; era de desespero."
                            ...
                            text "{i}mas dolorsamente, como se de alguma forma eu tivesse que evitar a ideia."
                            ...
                            text "{i}\"Quem é este jovem a chorar que ouço, e por que seus apelos são tão desesperados?"
                            ...
                            text "{i}alma de uma pessoa, um peso indelével como aquele o qual esmaga Atlas."
                    ...
                    if Memento == "Tablet16":
                        vbox spacing 10:
                            ...
                            text "{i}No ápice de sua vida, quando eu estava no cume de minha masculinidade,"
                            ...
                            text "{i}ainda assim, Thanatos não o abraçou, nem"
                            ...
                            text "{i}A chama que subjuguei com minhas palavras e sete noites depois"
                    ...
                    if Memento == "Tablet17":
                        vbox spacing 10:
                            ...
                            text "Na tábua está contido:"
                            text ""
                            text "{i}Ele era Astério, filho da Rainha Pasídae e criado pelo Rei Minos."
                            ...
                            text "{i}como, digo a mim mesmo, os próprios Destinos desejavam."
                            text ""
                            ...
                            text "{i}Eu olho para seus restos e que fúria me enche de ver"
                    ...
                    if Memento == "Tablet18":
                        vbox spacing 10:
                            text "{i}{size=+2}Décima Oitava Tábua: Skyros" xalign 0.5
                            text ""
                    ...
                    if Memento == "TypewriterScrap":
                        vbox spacing 10:
                            ...
                            text ""
                            text ""
                            text "Mostrar isso ao minotauro faz suas orelhas caírem e seus ombros encolherem."
                    ...
                    if Memento == "PoemNotebook":
                        vbox spacing 10:
                            ...
                            text "{i}Aquilo , is razed"
                            text "{i}tão perto quanto possível de uma origem."
